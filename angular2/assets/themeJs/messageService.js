function MessageService () {
	...
	var me = this;
	this.dns = '192.168.99.100';
	// this.dns = 'asb-live.cloudapp.net';

	// This call type will just make a call to the number then using built in voice repeat the message

	this.callMobile = function(phone, message) {
		var returnData = {};
